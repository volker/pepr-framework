 ...
 *
 */
public class DoublePropertyChooserBuilder implements PropertyChooserBuilder {
	...
	protected class PropertyChooserImpl implements PropertyChooser {
		...
		public Object getValue() {
			double value = 0l;
			try {
				value = Double.parseDouble(control.getText().trim());
			} catch (NumberFormatException ex) {
				control.setText(Double.toString(0d));
			}
		...
		public void setValue(Object value) {
			control.setText(Double.toString((Double) value));
		}
