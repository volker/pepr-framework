 ...
 *
 */
public class IntPropertyChooserBuilder implements PropertyChooserBuilder {
	...
	protected class PropertyChooserImpl implements PropertyChooser {
		...
		public Object getValue() {
			int value = 0;
			try {
				value = Integer.parseInt(control.getText().trim());
			} catch (NumberFormatException ex) {
				control.setText(Integer.toString(0));
			}
		...
		public void setValue(Object value) {
			control.setText(Integer.toString((Integer) value));
		}
