 ...
 *
 */
public class LongPropertyChooserBuilder implements PropertyChooserBuilder {
	...
	protected class PropertyChooserImpl implements PropertyChooser {
		...
		public Object getValue() {
			long value = 0l;
			try {
				value = Long.parseLong(control.getText().trim());
			} catch (NumberFormatException ex) {
				control.setText(Long.toString(0l));
			}
		...
		public void setValue(Object value) {
			control.setText(Long.toString((Long) value));
		}
